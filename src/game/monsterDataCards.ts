...
export const MONSTER_DATA_CARDS: Record<string, MonsterDataCard> = {
  ...
  'dungeon-explosive-fire-sac': simpleCard({ archetypeId: 'dungeon-explosive-fire-sac', name: '爆裂火囊怪', campaign: 1, kind: 'bomber', role: 'high-threat', hpBudget: 2.6, attackBudget: 1.05, speed: 70, basicAttackLabel: '火囊爆炸', skillLabel: '最终死亡自爆', behaviorTags: ['自爆', '火焰'], acceptance: '普通攻击与最终死亡自爆分别结算；图鉴与战斗都显示爆裂定位。' }),
  ...
  'dungeon-jailer-chief': simpleCard({ archetypeId: 'dungeon-jailer-chief', name: '腐化狱卒长', campaign: 1, kind: 'elite', role: 'caster', hpBudget: 22, attackBudget: 2.4, speed: 60, basicAttackLabel: '长剑挥击', skillLabel: '牢锁禁锢', behaviorTags: ['精英', '控制'], acceptance: '禁锢区域要有预警，不能直接出现在玩家脚下结算。' }),
