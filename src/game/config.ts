...
export const INFINITE_CHUNK_SIZE = 512
export const INFINITE_ACTIVE_CHUNK_RADIUS = 2
export const INFINITE_ACTIVE_CHUNK_LIMIT = (INFINITE_ACTIVE_CHUNK_RADIUS * 2 + 1) ** 2
export const INFINITE_OBSTACLE_SAFE_RADIUS = 280
export const INFINITE_SPAWN_MIN_DISTANCE = Math.max(WORLD_WIDTH, WORLD_HEIGHT) / 2 + 120
export const INFINITE_SPAWN_MAX_DISTANCE = Math.hypot(WORLD_WIDTH / 2, WORLD_HEIGHT / 2) + 720
export const INFINITE_ENEMY_RECYCLE_DISTANCE = Math.hypot(WORLD_WIDTH / 2, WORLD_HEIGHT / 2) + 980
export const CONTRACT_RIFT_RADIUS = 46
export const CONTRACT_RIFT_AUTO_SETTLE_TIME = 1.2
