...
> **2026-09-24 权威覆盖：角色等级、装备成长、强化与怪物材料。** 完整数值、结算和实现边界统一以 [`../../docs/character-equipment-progression-v1.md`](../../docs/character-equipment-progression-v1.md) 为准。本文下方早期 Demo 中的“每关技能点加基础属性”“重开重置长期成长”等描述均为历史内容，不再覆盖正式长期成长系统。
